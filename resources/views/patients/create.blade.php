...
<body class="bg-gray-100 p-10">
    ...
    <div class="container mx-auto max-w-lg">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-6">Ajouter un Patient</h1>
        ...
        <form action="{{ route('patients.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="adresse" id="adresse" rows="3" 
                          class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>{{ old('adresse') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="observations" id="observations" rows="3" 
                          class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('observations') }}</textarea>
            </div>
