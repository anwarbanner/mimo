...
<body class="bg-gray-100 p-10">
    ...
    <div class="container mx-auto max-w-lg">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-6">Modifier le Patient</h1>
        ...
        <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nom" id="nom" value="{{ old('nom', $patient->nom) }}" 
                       class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="adresse" id="adresse" rows="3" 
                          class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>{{ old('adresse', $patient->adresse) }}</textarea>
            </div>

            <div class="mb-4">
                <label for="date_naissance" class="block text-gray-700 font-semibold mb-2">Date de Naissance :</label>
                <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $patient->date_naissance) }}" 
                       class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="observations" id="observations" rows="3" 
                          class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('observations', $patient->observations) }}</textarea>
            </div>
