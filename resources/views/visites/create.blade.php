...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg my-6">
    ...
    <form action="{{ route('visites.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="w-full max-w-7xl bg-white shadow-lg rounded-lg p-8">
            ...
            <div class="space-y-4">
                @foreach ($questions->chunk(ceil($questions->count() / 3)) as $index => $chunk)
                    <div class="border border-gray-200 rounded-lg">
                        <button type="button"
                            ...
                            <svg id="icon-accordion-{{ $index }}" xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 transition-transform transform" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                            ...
                            <div class="p-4 bg-gray-50">
                                @foreach ($chunk as $question)
                                    <div class="mb-6">
                                        ...
                                        <input type="hidden" name="questions[{{ $question->id }}][question_id]"
                                            value="{{ $question->id }}">

                                        <!-- Gestion des types de question -->
        ...
        <div>
            ...
            <button type="button" onclick="addSoin()" class="text-blue-500 hover:text-blue-700 mt-4">+ Ajouter un soin</button>
        </div>
        ...
        <div>
            ...
            <button type="button" onclick="addProduct()" class="text-blue-500 hover:text-blue-700 mt-4">+ Ajouter un produit</button>
        </div>
